...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="animlogin.css" />
  </head>
  <body>
    <div class="ocean">
      <!-- <div class="wave"></div>
  ...
  <section>
      <div class="container" id="container">
          <div class="form-container sign-up-container">
              <form action="../animincludes/signup-inc.php" method="POST">
                  <h1>Sign Up</h1>
          ...
          <div class="form-container sign-in-container">
              <form action="../animincludes/login-inc.php" method="POST">
                  <h1>Login</h1>
                  <div class="social-container">
                      <a href="https://Github.com/AtharvaKulkarniIT" target="_blank" class="social"><i class="fab fa-github"></i></a>
                        </div>
  ...
  <script src='https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.2.3/js/bootstrap.min.js'></script>
    <script src="animlogin.js"></script>
  </body>
</html>